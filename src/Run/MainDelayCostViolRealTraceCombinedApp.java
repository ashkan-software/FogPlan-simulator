...
public class MainDelayCostViolRealTraceCombinedApp {
    ...
    private final static int TAU = 180; // time interval between run of the method (s)
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        for (int i = 0; i < TOTAL_RUN; i++) {
            ...
            costFogDynamicViol = FogDynamicViol.getCost(Parameters.TRAFFIC_CHANGE_INTERVAL);

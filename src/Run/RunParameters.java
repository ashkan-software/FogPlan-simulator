...
public class RunParameters {
    ...
    public final static int NUM_FOG_NODES = 100; // opt 10. DTMC 100. threshold 10
    public final static int NUM_SERVICES = 50; // opt 2. DTMC 50. threshold 20
    public final static int NUM_CLOUD_SERVERS = 25; // opt 3. DTMC 25. threshold 3

...
public class Parameters {
    ...
    public final static double L_P_min = 50d; // Towards QoS-aware Fog Service Placement (they have simuation, and it their simulation, they have 50,100 and 200
    ...
    public static void initialize() {
        ...
        ArrayFiller.fill1DArrayRandomlyInRange(q, 0.9, 0.99999);
        ...
        ArrayFiller.fill1DArrayRandomlyInRange(dIF, 1d, 2d);
        ...
        ArrayFiller.fill1DArrayRandomlyInRange(KP, KP_min, 1300d); // in MIPS
        ...
        ArrayFiller.fill1DArrayRandomlyInRange(KpS, 250d * 1000d * 1000d * 1000d * 8d, 250d * 1000d * 1000d * 1000d * 8d); // 200GB
...
//        double f_min = (double) 1 / numServices;
